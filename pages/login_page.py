...
class LoginPage(BasePage):
    ...
    def register_new_user(self, email, password):
        ...
        self.browser.find_element(*LoginPageLocators.REG_PASSWORD_LINK).send_keys(password)
        self.browser.find_element(*LoginPageLocators.REG_REPEAT_PASSWORD_LINK).send_keys(password)
